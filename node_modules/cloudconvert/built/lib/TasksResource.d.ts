...
export declare type ImportOperation = ImportUrl | ImportUpload | ImportBase64 | ImportRaw | ImportS3 | ImportAzureBlob | ImportGoogleCloudStorage | ImportOpenStack | ImportSFTP;
export declare type TaskOperation = TaskConvert | TaskOptimize | TaskCapture | TaskThumbnail | TaskMerge | TaskArchive | TaskCommand | TaskMetadata | TaskMetadataWrite;
